...
<form action="index.php" method="post" id="myForm" enctype="multipart/form-data" class="form-horizontal">
    ...
    <div class="bar">
        <button type="submit" class="btn btn-danger" name="file" value="pdf">
            <i class="fa fa-file-pdf" aria-hidden="true"></i> pdf <{$smarty.const._MD_TAD_SIGNUP_SIGNIN_TABLE}>
        </button>
        <button type="submit" class="btn btn-primary" name="file" value="word">
            <i class="fa fa-file-pdf" aria-hidden="true"></i> word <{$smarty.const._MD_TAD_SIGNUP_SIGNIN_TABLE}>
        </button>
        <button type="submit" class="btn btn-success" name="file" value="odt">
            <i class="fa fa-file-pdf" aria-hidden="true"></i> odt <{$smarty.const._MD_TAD_SIGNUP_SIGNIN_TABLE}>
        </button>
    </div>
</form>